...
// import pic4 from '../../../Data/uildver4 2017.jpg';
                                            ...
                                            {images.map((item, index) => (
                                                <div className="item" key={index}>
                                                    <div className="ow-img">
                                                        <NavLink to="/about"><img src={item} alt="" className='bg-cover' style={{ aspectRatio: "1" }} /></NavLink>
                                                    </div>
                                                </div>
                                            ))}
                                    ...
                                    <div className="m-about-containt text-black p-t80">
                                        ...
                                        <div className="author-info p-t20">
                                            ...
                                            <div className="author-name">
                                                <h4 className="m-t0">ЗАХИРАЛ</h4>
                                                <p>Үүсгэн байгуулагч</p>
                                            </div>
                                            <NavLink to="/contactus" className="site-button btn-effect m-b15"><span>Холбогдох</span></NavLink>
                                        </div>
                                    </div>
                                </div>
                            </div>
